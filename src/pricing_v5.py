...
ZONE_SECTIONS = {
    "T6": ["101", "102"],
    "T5": ["103","104","113","114","115","116","117","118","129","130",
           "218","219","220","221","222","223","224","225"],
    "T4": ["319","320","321","322","323","324"],
    "T3": ["105","106","107","108","110","111","112",
           "119","120","121","122","123","124","128",
           "208","209","210","211","212","213","214","215","216","217",
           "226","227","228","229","230","231","232","237",
           "317","318","325","326","337","338"],
    "T2": ["308","309","314","315","316","327","328","329"],
...
# 价格弹性不随对手级别变化（球迷买票看对手，不看价格）
TIER_ELASTICITY_MULTIPLIER = {
    "S_S": 1.0, "S_A": 1.0, "S_Aminus": 1.0,
    "S_B": 1.0, "S_C": 1.0, "S_Cminus": 1.0,
}
...
ZONE_ADJUSTMENT_BOUNDS = {
    ...
    # T4: 精品区 — 锁
    "T4": {
        "S_S": (1.00, 1.00), "S_A": (1.00, 1.00),
        "S_Aminus": (1.00, 1.00),
        "S_B": (1.00, 1.00), "S_C": (1.00, 1.00),
        "S_Cminus": (1.00, 1.00),
    },
    # T5: 收入锚 — 高价创收，可涨可降
    "T5": {
