...
OUT = ROOT / "assets" / "stadium_seating_b_class.svg"
...
SEG = {"125", "127", "233", "236", "333", "336", "337"}
WHITE = {"205", "206", "207", "239", "240", "301", "302", "303", "304", "305", "306", "307", "339", "340"}

SECTION_PRICE: dict[str, int] = {}
for s in ("101", "102"):
    SECTION_PRICE[s] = 1080
for s in (
    "103", "104", "113", "114", "115", "116", "117", "118", "129", "130",
...
for s in ("319", "320", "321", "322", "323", "324"):
    SECTION_PRICE[s] = 460
for s in (
    "105", "106", "107", "108", "109", "110", "111", "112", "119", "120", "121", "122",
    "123", "124", "128", "208", "209", "210", "211", "212", "213", "214", "215", "216",
    "217", "226", "227", "228", "229", "230", "231", "232", "237", "238", "317", "318",
    "325", "326", "338",
):
    SECTION_PRICE[s] = 300
for s in ("308", "309", "314", "315", "316", "327", "328", "329"):
    SECTION_PRICE[s] = 220
...
def build_svg() -> str:
    parts = [
        ...
        "<!-- 纯矢量：path + text，无内嵌 PNG/JPEG；由 scripts/generate_stadium_svg.py 生成 -->",
