...
def build_svg() -> str:
    parts = [
        ...
        *vip_paths(),
        ...
        '<text x="812" y="619" font-size="10" font-family="Arial,sans-serif" fill="#333">319-324 工会专供 ¥276（不对外）</text>',
        ...
        '<text x="812" y="691" font-size="10" font-family="Arial,sans-serif" fill="#333">球迷区 107-110（4场联票¥648）</text>',
        '</g>',
        "</svg>",
    ]
    return "\n".join(parts) + "\n"
